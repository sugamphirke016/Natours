...
// To toggle the password visiblity button
function showHide() {
...
// To get the user entered OTP from the otp box
...
// Func for handling otp box working
...
// This logic sends the user entered otp to the firebase for verification and accordingly displays the user interface
function codeverify() {
    let otp = "";
    inputs.forEach((input) => {
        otp += input.value;
...
// To change sytles after sending mail to user
var sentMsg = " " + email + "";
document.getElementById("sentMsg").textContent = sentMsg;
